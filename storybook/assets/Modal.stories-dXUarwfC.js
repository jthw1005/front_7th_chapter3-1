import{r,j as e}from"./iframe-pCu_qHIV.js";import{B as s}from"./button-CMutOxu2.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DUjkeKZY.js";import"./index-B_jtOnfb.js";import"./utils-CDN07tui.js";const o=({isOpen:t,onClose:n,title:x,children:h,size:b="medium",showFooter:O=!1,footerContent:f})=>{if(r.useEffect(()=>(t?document.body.style.overflow="hidden":document.body.style.overflow="unset",()=>{document.body.style.overflow="unset"}),[t]),!t)return null;const v={small:"w-full max-w-[400px]",medium:"w-full max-w-[600px]",large:"w-full max-w-[900px]"};return e.jsx("div",{className:"fixed inset-0 bg-black/50 flex items-center justify-center z-[1000] p-4",onClick:n,children:e.jsxs("div",{className:`bg-white dark:bg-gray-800 rounded flex flex-col max-h-[90vh] font-sans shadow-[0px_11px_15px_-7px_rgba(0,0,0,0.2),0px_24px_38px_3px_rgba(0,0,0,0.14),0px_9px_46px_8px_rgba(0,0,0,0.12)] ${v[b]}`,onClick:j=>j.stopPropagation(),children:[x&&e.jsxs("div",{className:"px-6 py-4 border-b border-black/12 dark:border-white/12 flex justify-between items-center",children:[e.jsx("h3",{className:"m-0 text-xl font-medium text-black/87 dark:text-white/87",children:x}),e.jsx("button",{className:"bg-transparent border-none text-[28px] leading-none text-black/54 dark:text-white/54 cursor-pointer p-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-black/4 dark:hover:bg-white/4",onClick:n,children:"×"})]}),e.jsx("div",{className:"p-6 overflow-y-auto flex-1",children:h}),O&&f&&e.jsx("div",{className:"px-6 py-4 border-t border-black/12 dark:border-white/12 flex gap-2 justify-end",children:f})]})})};o.__docgenInfo={description:"",methods:[],displayName:"Modal",props:{isOpen:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},title:{required:!1,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'large'"}]},description:"",defaultValue:{value:"'medium'",computed:!1}},showFooter:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},footerContent:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const I={title:"Shared/Modal",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium","large"],description:"Modal size"},isOpen:{control:"boolean",description:"Modal open state"},showFooter:{control:"boolean",description:"Show footer"}}},a={render:()=>{const[t,n]=r.useState(!1);return e.jsxs("div",{children:[e.jsx(s,{onClick:()=>n(!0),children:"Open Modal"}),e.jsx(o,{isOpen:t,onClose:()=>n(!1),title:"Modal Title",children:e.jsx("p",{children:"This is the modal content. Click outside or press the X button to close."})})]})}},i={render:()=>{const[t,n]=r.useState(!1);return e.jsxs("div",{children:[e.jsx(s,{onClick:()=>n(!0),children:"Open Small Modal"}),e.jsx(o,{isOpen:t,onClose:()=>n(!1),title:"Small Modal",size:"small",children:e.jsx("p",{children:"This is a small modal. Perfect for quick confirmations or brief messages."})})]})}},l={render:()=>{const[t,n]=r.useState(!1);return e.jsxs("div",{children:[e.jsx(s,{onClick:()=>n(!0),children:"Open Medium Modal"}),e.jsx(o,{isOpen:t,onClose:()=>n(!1),title:"Medium Modal",size:"medium",children:e.jsx("p",{children:"This is a medium-sized modal. It provides more space for content while remaining manageable."})})]})}},d={render:()=>{const[t,n]=r.useState(!1);return e.jsxs("div",{children:[e.jsx(s,{onClick:()=>n(!0),children:"Open Large Modal"}),e.jsx(o,{isOpen:t,onClose:()=>n(!1),title:"Large Modal",size:"large",children:e.jsx("p",{children:"This is a large modal. Great for forms, detailed content, or complex layouts."})})]})}},c={render:()=>{const[t,n]=r.useState(!1);return e.jsxs("div",{children:[e.jsx(s,{onClick:()=>n(!0),children:"Open Modal with Footer"}),e.jsx(o,{isOpen:t,onClose:()=>n(!1),title:"Confirm Action",showFooter:!0,footerContent:e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"secondary",onClick:()=>n(!1),children:"Cancel"}),e.jsx(s,{variant:"primary",onClick:()=>n(!1),children:"Confirm"})]}),children:e.jsx("p",{children:"Are you sure you want to perform this action?"})})]})}},m={render:()=>{const[t,n]=r.useState(!1);return e.jsxs("div",{children:[e.jsx(s,{onClick:()=>n(!0),children:"Open Modal without Title"}),e.jsx(o,{isOpen:t,onClose:()=>n(!1),children:e.jsxs("div",{className:"text-center",children:[e.jsx("h2",{className:"text-xl font-bold mb-4",children:"Custom Header"}),e.jsx("p",{children:"This modal doesn't use the standard title prop."})]})})]})}},p={render:()=>{const[t,n]=r.useState(!1);return e.jsxs("div",{children:[e.jsx(s,{onClick:()=>n(!0),children:"Open Modal with Long Content"}),e.jsx(o,{isOpen:t,onClose:()=>n(!1),title:"Terms and Conditions",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."}),e.jsx("p",{children:"Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."}),e.jsx("p",{children:"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."}),e.jsx("p",{children:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."}),e.jsx("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."}),e.jsx("p",{children:"Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."})]})})]})}},u={render:()=>{const[t,n]=r.useState(!1);return e.jsxs("div",{children:[e.jsx(s,{onClick:()=>n(!0),children:"Open Form Modal"}),e.jsx(o,{isOpen:t,onClose:()=>n(!1),title:"Create New User",size:"medium",showFooter:!0,footerContent:e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"secondary",onClick:()=>n(!1),children:"Cancel"}),e.jsx(s,{variant:"primary",onClick:()=>n(!1),children:"Create User"})]}),children:e.jsxs("form",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"name",className:"block text-sm font-medium mb-1",children:"Name"}),e.jsx("input",{type:"text",id:"name",className:"w-full px-3 py-2 border border-gray-300 rounded",placeholder:"Enter name"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"email",className:"block text-sm font-medium mb-1",children:"Email"}),e.jsx("input",{type:"email",id:"email",className:"w-full px-3 py-2 border border-gray-300 rounded",placeholder:"Enter email"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"role",className:"block text-sm font-medium mb-1",children:"Role"}),e.jsxs("select",{id:"role",className:"w-full px-3 py-2 border border-gray-300 rounded",children:[e.jsx("option",{children:"User"}),e.jsx("option",{children:"Admin"}),e.jsx("option",{children:"Moderator"})]})]})]})})]})}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: () => {
