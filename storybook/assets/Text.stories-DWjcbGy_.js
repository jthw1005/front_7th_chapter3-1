import{j as e}from"./iframe-pCu_qHIV.js";import{c as S}from"./index-B_jtOnfb.js";import{c as v}from"./utils-CDN07tui.js";import"./preload-helper-PPVm8Dsz.js";const j={heading1:"h1",heading2:"h2",heading3:"h3",heading4:"h4",heading5:"h5",heading6:"h6",subHeading1:"h3",subHeading2:"h5",subHeading3:"h6",title1:"span",title2:"span",body1:"span",body2:"span",caption1:"span",caption2:"span",button1:"span",button2:"span"},B=S("box-border",{variants:{type:{heading1:"text-[24px] font-[700] -tracking-[0.8px]",heading2:"text-[20px] font-[700] -tracking-[0.72px]",heading3:"text-[18px] font-[700] -tracking-[0.56px]",heading4:"text-[16px] font-[700] -tracking-[0.48px]",heading5:"text-[16px] font-[700] -tracking-[0.4px]",heading6:"text-[16px] font-[700] -tracking-[0.36px]",subHeading1:"text-[28px] font-[500] -tracking-[0.56px]",subHeading2:"text-[20px] font-[500] -tracking-[0.4px]",subHeading3:"text-[18px] font-[500] -tracking-[0.36px]",title1:"text-[16px] font-[700] -tracking-[0.32px]",title2:"text-[14px] font-[700] -tracking-[0.28px]",body1:"text-[16px] font-[400] -tracking-[0.32px]",body2:"text-[14px] font-[400] -tracking-[0.28px]",caption1:"text-[12px] font-[400] -tracking-[0.24px]",caption2:"text-[10px] font-[400] -tracking-[0.2px]",button1:"text-[16px] font-[500] -tracking-[0.32px]",button2:"text-[14px] font-[500] -tracking-[0.28px]"}},defaultVariants:{type:"body2"}}),t=({textType:u="body2",className:h,children:b})=>{const H=j[u];return e.jsx(H,{className:v(B({type:u}),h),children:b})};t.__docgenInfo={description:"",methods:[],displayName:"Text",props:{textType:{required:!1,tsType:{name:"union",raw:`| 'heading1'
| 'heading2'
| 'heading3'
| 'heading4'
| 'heading5'
...
}`,...m.parameters?.docs?.source}}};const L=["Heading1","Heading2","Heading3","SubHeading1","Title1","Body1","Body2","Caption1","Caption2","Button1","Button2","AllHeadings","AllSubHeadings","AllBodyText","TypographyScale"];export{y as AllBodyText,g as AllHeadings,T as AllSubHeadings,d as Body1,p as Body2,l as Button1,c as Button2,o as Caption1,x as Caption2,a as Heading1,n as Heading2,i as Heading3,r as SubHeading1,s as Title1,m as TypographyScale,L as __namedExportsOrder,A as default};
